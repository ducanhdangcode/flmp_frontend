...
const CoachProfileRecordAgainstManager = ({coach}) => {
  return (
    <div>
        {/* header */}
        <div className = "w-[93%] bg-easeGreen text-center py-[0.5rem] mt-[2.5rem]">
            <p className = "font-teko font-bold text-xl relative top-[0.1rem]">RECORD AGAINST MANAGERS</p>
        </div>
        ...
        <table className = "mt-[1rem] w-[93%]">
            <thead>
                <tr className = "h-[2rem] border-solid border-b-[1px] border-b-gray-500 bg-mediumGreen font-space-grotesk">
                    <th className = "w-[30%] border-solid border-r-[1px] border-r-gray-500">Manager</th>
            ...
            <tbody>
                {coach?.recordsAgainstManager.map((record) => {
                    return (
                        <tr className = "h-[2rem] bg-easeWhite text-center border-solid border-b-[1px] border-b-gray-500 font-space-grotesk">
                            <td className = "border-solid border-r-[1px] border-r-gray-500 h-[2rem]">{record?.managerName}</td>
...
export default CoachProfileRecordAgainstManager
