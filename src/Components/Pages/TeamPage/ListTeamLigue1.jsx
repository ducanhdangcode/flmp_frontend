  ...
  return (
    <div className = "relative" style = {{backgroundColor: theme === lightColor ? "" : "#171447", height: "60rem"}} data-aos = "zoom-out-up">
        ...
        <div className = "relative top-16 flex" style = {{flexFlow: "row wrap"}}>
            ...
            <TeamCard TeamLogo = {AngersLogo} TeamName = {"Angers SCO"} addStyle={{top: "0.8rem", left: "0.8rem", height: "4.5rem", width: "4.5rem"}} addStyleText = {{left: "1.3rem", top: "2rem"}} colorTheme = {theme} lightColor = {lightColor} darkColor = {darkColor} hoverColor={"black"} hoverImage={Ligue1Pattern} hoverTeamLogo={AngersLogo} hoverStyle={{top: "0.8rem", left: "0.8rem", height: "4.5rem", width: "4.5rem"}} hoverStyleText={{left: "1.3rem", top: "2rem", color: "white"}}/>
        </div>
    </div>
  )
}
