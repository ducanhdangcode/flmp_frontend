...
const ListTeamSerieA = ({colorTheme, lightColor, darkColor}) => {
  ...
  return (
    <div className = "relative" style = {{backgroundColor: colorTheme === lightColor ? "#c8ccc0" : "", height: "65rem", top: "40rem"}} data-aos = "zoom-out-up">
        ...
        <div className = "relative top-16 flex" style = {{flexFlow: "row wrap"}}>
            ...
            <TeamCard TeamLogo = {EmpoliLogo} TeamName = {"Empoli"} addStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} addStyleText = {{left: "2rem", top: "2rem"}} colorTheme = {colorTheme} lightColor = {lightColor} darkColor = {darkColor} hoverColor={"#286feb"} hoverImage={SerieAPattern} hoverTeamLogo={EmpoliLogo} hoverStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} hoverStyleText={{left: "2rem", top: "2rem", color: "white"}}/>

            <TeamCard TeamLogo = {FiorentinaLogo} TeamName = {"ACF Fiorentina"} addStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} addStyleText = {{left: "2rem", top: "2rem"}} colorTheme = {colorTheme} lightColor = {lightColor} darkColor = {darkColor} hoverColor={"#8e20bd"} hoverImage={SerieAPattern} hoverTeamLogo={FiorentinaLogo} hoverStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} hoverStyleText={{left: "2rem", top: "2rem", color: "white"}}/>

            <TeamCard TeamLogo = {VeronaLogo} TeamName = {"Hellas Verona"} addStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} addStyleText = {{left: "2rem", top: "2rem"}} colorTheme = {colorTheme} lightColor = {lightColor} darkColor = {darkColor} hoverColor={"white"} hoverImage={SerieAPattern} hoverTeamLogo={VeronaLogo} hoverStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} hoverStyleText={{left: "2rem", top: "2rem"}}/>

            <TeamCard TeamLogo = {BolognaLogo} TeamName = {"Bologna 1909"} addStyle={{top: "0.8rem", left: "1.7rem", height: "4.5rem", width: "2.7rem"}} addStyleText = {{left: "3.5rem", top: "2rem"}} colorTheme = {colorTheme} lightColor = {lightColor} darkColor = {darkColor} hoverColor={"#701409"} hoverImage={SerieAPattern} hoverTeamLogo={BolognaLogo} hoverStyle={{top: "0.8rem", left: "1.7rem", height: "4.5rem", width: "2.7rem"}} hoverStyleText={{left: "3.5rem", top: "2rem", color: "white"}}/>

            <TeamCard TeamLogo = {ComoLogo} TeamName = {"Calcio Como"} addStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} addStyleText = {{left: "2rem", top: "2rem"}} colorTheme = {colorTheme} lightColor = {lightColor} darkColor = {darkColor} hoverColor={"#1556b0"} hoverImage={SerieAPattern} hoverTeamLogo={ComoLogo} hoverStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} hoverStyleText={{left: "2rem", top: "2rem", color: "white"}}/>
            ...
            <TeamCard TeamLogo = {VeneziaLogo} TeamName = {"Venezia"} addStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} addStyleText = {{left: "2rem", top: "2rem"}} colorTheme = {colorTheme} lightColor = {lightColor} darkColor = {darkColor} hoverColor={"black"} hoverImage={SerieAPattern} hoverTeamLogo={VeneziaLogo} hoverStyle={{top: "0.8rem", left: "1rem", height: "4.5rem", width: "4.5rem"}} hoverStyleText={{left: "2rem", top: "2rem", color: "white"}}/>
        </div>
    </div>
  )
}
