...
const Kit = ({teamId, teamList, teamKits}) => {
  return (
    <div className = "absolute" style = {{top: "82rem"}}>
      ...
      <div className = "relative left-8 top-8 flex">
        {teamKits.map((kit, index) => {
            return <div className = "relative rounded-2xl mr-48" style = {{backgroundColor: "#8c8484", width: "20rem", height: "21rem", boxShadow: `0.3rem 0.3rem 0.5rem ${teamList[teamId-1]?.kitColors[index]}`}}>
