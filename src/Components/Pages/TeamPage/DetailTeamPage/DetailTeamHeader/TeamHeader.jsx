  ...
  return (
    <div>
        <div className = "relative w-full" style = {{top: "0rem", height: "23rem", backgroundColor: "#a6a5a4"}}>
            ...
            {team && <p className = "relative font-roboto font-bold" style = {{left: "22rem", bottom: "8.5rem", fontSize: "6rem"}}>{team?.name.toUpperCase()}</p>}
            ...
            <div className = "absolute z-10" style = {{top: "17rem", left: "80rem"}}>
                {team?.favoriteState === "unfavorite" ? <button className = "rounded-2xl bg-white" style = {{width: "13rem", height: "4rem", borderWidth: "4px", borderColor: team?.color}} onClick = {handleAddFavoriteTeams}>
                    <span><FaStar className = "relative top-3 left-2" style = {{width: "2.2rem", height: "2.2rem"}}/></span>
                    <span className = "text-3xl font-ubuntu relative" style = {{bottom: "1.8rem", left: "1rem", color: team?.color}}>Favorite</span>
                </button> : 
