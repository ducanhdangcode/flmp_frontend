...
const SpeficPersonalFormation = ({user, drawFormation, teamList, teamId, activePersonalFormationIndex, handleChangeActivePersonalFormationIndex, handleSetNextActiveIndex, handleSetPreviousActiveIndex, startPaginationIndex, handleChangeGroupIndex}) => {
  return (
    <div>
        <div className = "flex">
            ...
            <div className = "relative top-[2rem] w-[25rem]">
                ...
                <div>
                    {user?.personalFormations[activePersonalFormationIndex-1]?.mainSquad.map((player, index) => {
                        if (user?.personalFormations[activePersonalFormationIndex-1]?.formationName === "3-4-2-1") {
                            return drawFormation(0, player, index);
                        } else if (user?.personalFormations[activePersonalFormationIndex-1]?.formationName === "3-4-3") {
                            return drawFormation(1, player, index);
                        } else if (user?.personalFormations[activePersonalFormationIndex-1]?.formationName === "4-3-3") {
                            return drawFormation(2, player, index);
                        } else if (user?.personalFormations[activePersonalFormationIndex-1]?.formationName === "4-2-3-1") {
                            return drawFormation(3, player, index);
                        } else if (user?.personalFormations[activePersonalFormationIndex-1]?.formationName === "4-4-2") {
                            return drawFormation(4, player, index);
                        } else if (user?.personalFormations[activePersonalFormationIndex-1]?.formationName === "4-1-4-1") {
        ...
        <div className = "relative left-[4rem] top-[3rem]">
            ...
            <div className = "flex flex-wrap mt-[0.5rem] w-[50rem]">
                {user?.personalFormations[activePersonalFormationIndex-1]?.substitutions.map((player, index) => {
                    return (
