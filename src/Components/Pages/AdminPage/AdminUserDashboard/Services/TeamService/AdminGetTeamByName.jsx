...
import { getTeamByTeamName } from '../../../../../../APIService/TeamService';

const AdminGetTeamByName = () => {
    ...
    const handleExecute = () => {
        ...
        getTeamByTeamName(inputTeamName).then((response) => {
  ...
  return (
    <div>
        ...
        <ServiceHeaderTemplates 
            ...
            borderColor={"#076aeb"}
            method = {"GET"}
            path = {`/api/teams/get-by-name/{team-name}`}
            description={"Get specified team by team name"}
        />
            ...
            <div>
                ...
                <div>
                    ...
                    <div className = "flex relative left-[2vw] w-[94%] mt-[1rem]">
                        ...
                        {/* description */}
                        <p className = "font-changa relative left-[0.5vw] w-[20%]">Name of team that you want to get</p>
                        {/* parameter type */}
...
const ServiceResponse = ({status, responseTeam}) => {
    return (
        <div className = "w-[92vw] bg-[#b3d3fc] rounded-[8px] pb-[1rem]">
            {/* title */}
            <div className = "relative left-[2vw] top-[0.5rem]">
                        ...
                        <div className = "w-full bg-gray-800 mt-[0.5rem] text-white">
                            {responseTeam ? 
                                <div className = "overflow-auto">
                                    <pre className = "font-code" style = {{width: "80%"}}>{JSON.stringify(responseTeam, null, 2)}</pre>
                                </div> : 
...
export default AdminGetTeamByName
