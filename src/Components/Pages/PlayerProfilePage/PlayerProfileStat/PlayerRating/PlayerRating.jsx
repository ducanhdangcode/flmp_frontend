...
const PlayerRating = ({player}) => {
  return (
    <div>
      {/* header */}
      <div className = "w-[40%] h-[2rem] bg-[#060433] font-ubuntu text-lg text-white font-bold text-center">
          <p>Player Rating</p>
      </div>
      <div className = "w-[40%] h-[25rem] bg-gray-300">
        ...
        <div>
          <p className = "text-center font-changa relative top-[0.5rem]"><b>{player?.name}</b>'s rating based on all performances</p>
        </div>
      </div>
    </div>
  )
