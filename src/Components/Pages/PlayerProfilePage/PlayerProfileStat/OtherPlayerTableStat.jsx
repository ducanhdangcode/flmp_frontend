    ...
    <div>
      <table>
        ...
        <tbody>
            {seasonStat.map((stat) => {
                return (
                    <tr className = "h-[2rem] bg-white text-center border-solid border-b-[1px] border-b-gray-500 font-changa">
            ...
            <tr className = "h-[2rem] border-solid border-b-[1px] border-b-gray-500 bg-gray-200 text-center font-changa">
                <td className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500 h-[2rem]">Total stats 24-25:</td>
                <td className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500 h-[2rem]">{totalStats.appearances}</td>
                <td className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500 h-[2rem]">{totalStats.goals}</td>
                <td className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500 h-[2rem]">{totalStats.assists}</td>
                <td className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500 h-[2rem]">{totalStats.yellowCards}</td>
                <td className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500 h-[2rem]">{totalStats.redCards}</td>
                <td className = "w-[12.75rem] h-[2rem]">{`${totalStats?.minutePlayed}'`}</td>
            </tr>
        </tbody>
      </table>
    </div>
