...
const OtherPlayerStatTableByTeam = ({allStatsGroupByTeam}) => {
  return (
    <div>
        {/* title */}
            ...
            <table className = "font-space-grotesk">
                <thead>
                    <tr className = "h-[2rem] border-solid border-b-[1px] border-b-gray-500 bg-gray-300">
                        ...
                        <th className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500">Assists</th>
                    ...
                    {allStatsGroupByTeam.map((teamStat, index) => {
                        return (
                            <tr className = "h-[2rem] bg-white text-center border-solid border-b-[1px] border-b-gray-500">
                                ...
                                <td className = "w-[12.75rem] border-solid border-r-[1px] border-r-gray-500 h-[2rem]">{teamStat.assists > 0 ? teamStat.assists : "-"}</td>
...
export default OtherPlayerStatTableByTeam
